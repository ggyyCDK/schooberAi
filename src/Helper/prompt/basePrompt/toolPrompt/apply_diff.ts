export function getApplyDiffDescription(workdir): string {
    return `## apply_diff
...
Parameters:
- path: (required) The path of the file to modify (relative to the current workspace directory ${workdir})
