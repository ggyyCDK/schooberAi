...
_MastraVoice_decorators = [chunkV6NA7QLK_cjs.InstrumentClass({
  prefix: "voice",
  excludeMethods: ["__setTools", "__setLogger", "__setTelemetry", "#log"]
})];
exports.MastraVoice = class MastraVoice extends (_a = chunkYT4RGZYO_cjs.MastraBase) {
  listeningModel;
  speechModel;
  speaker;
  realtimeConfig;
...
//# sourceMappingURL=chunk-VZUGB775.cjs.map
//# sourceMappingURL=chunk-VZUGB775.cjs.map