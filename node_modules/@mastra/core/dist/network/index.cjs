...
var AgentNetwork = class extends chunkYT4RGZYO_cjs.MastraBase {
  #instructions;
  #agents;
  #model;
  #routingAgent;
  #agentHistory = {};
  constructor(config) {
    super({ component: chunkIDDUQR6P_cjs.RegisteredLogger.NETWORK, name: config.name || "AgentNetwork" });
  ...
  getTools() {
    return {
      transmit: chunkH65GI7JY_cjs.createTool({
        id: "transmit",
