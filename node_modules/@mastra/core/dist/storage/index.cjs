...
var LegacyEvalsStorage = class extends chunkYT4RGZYO_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "LEGACY_EVALS"
...
var MemoryStorage = class extends chunkYT4RGZYO_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "MEMORY"
...
var StoreOperations = class extends chunkYT4RGZYO_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "OPERATIONS"
...
var StoreOperationsInMemory = class extends StoreOperations {
  ...
  async insert({ tableName, record }) {
    ...
    let key = record.id;
    if ([chunk6P2Q536B_cjs.TABLE_WORKFLOW_SNAPSHOT, chunk6P2Q536B_cjs.TABLE_EVALS].includes(tableName) && !record.id && record.run_id) {
      key = record.run_id;
      record.id = key;
    } else if (!record.id) {
...
var ScoresStorage = class extends chunkYT4RGZYO_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "SCORES"
...
var TracesStorage = class extends chunkYT4RGZYO_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "TRACES"
...
var TracesInMemory = class extends TracesStorage {
  ...
  async batchTraceInsert({ records }) {
    ...
    await this.operations.batchInsert({
      tableName: chunk6P2Q536B_cjs.TABLE_TRACES,
      records
    });
  }
};
...
var WorkflowsStorage = class extends chunkYT4RGZYO_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "WORKFLOWS"
...
var WorkflowsInMemory = class extends WorkflowsStorage {
  ...
  async persistWorkflowSnapshot({
    ...
    await this.operations.insert({
      tableName: chunk6P2Q536B_cjs.TABLE_WORKFLOW_SNAPSHOT,
      record: data
    });
  }
...
// src/storage/mock.ts
var InMemoryStore = class extends chunkGRL3ZK5B_cjs.MastraStorage {
  stores;
  constructor() {
...
function safelyParseJSON(jsonParam) {
...
Object.defineProperty(exports, "MastraStorage", {
  enumerable: true,
  get: function () { return chunkGRL3ZK5B_cjs.MastraStorage; }
});
Object.defineProperty(exports, "ensureDate", {
  enumerable: true,
  get: function () { return chunkGRL3ZK5B_cjs.ensureDate; }
});
Object.defineProperty(exports, "resolveMessageLimit", {
  enumerable: true,
  get: function () { return chunkGRL3ZK5B_cjs.resolveMessageLimit; }
});
Object.defineProperty(exports, "serializeDate", {
  enumerable: true,
  get: function () { return chunkGRL3ZK5B_cjs.serializeDate; }
});
Object.defineProperty(exports, "SCORERS_SCHEMA", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.SCORERS_SCHEMA; }
});
Object.defineProperty(exports, "TABLE_EVALS", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_EVALS; }
});
Object.defineProperty(exports, "TABLE_MESSAGES", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_MESSAGES; }
});
Object.defineProperty(exports, "TABLE_RESOURCES", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_RESOURCES; }
});
Object.defineProperty(exports, "TABLE_SCHEMAS", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_SCHEMAS; }
});
Object.defineProperty(exports, "TABLE_SCORERS", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_SCORERS; }
});
Object.defineProperty(exports, "TABLE_THREADS", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_THREADS; }
});
Object.defineProperty(exports, "TABLE_TRACES", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_TRACES; }
});
Object.defineProperty(exports, "TABLE_WORKFLOW_SNAPSHOT", {
  enumerable: true,
  get: function () { return chunk6P2Q536B_cjs.TABLE_WORKFLOW_SNAPSHOT; }
});
