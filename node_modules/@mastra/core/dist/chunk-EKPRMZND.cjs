...
_MastraTTS_decorators = [chunkV6NA7QLK_cjs.InstrumentClass({
  prefix: "tts",
  excludeMethods: ["__setTools", "__setLogger", "__setTelemetry", "#log"]
})];
exports.MastraTTS = class MastraTTS extends (_a = chunkYT4RGZYO_cjs.MastraBase) {
  model;
  constructor({
    model
  }) {
...
//# sourceMappingURL=chunk-EKPRMZND.cjs.map
//# sourceMappingURL=chunk-EKPRMZND.cjs.map