...
var MessageList = class _MessageList {
  ...
  static isVercelUIMessage(msg) {
    return !_MessageList.isMastraMessage(msg) && chunkMW267UVU_cjs.isUiMessage(msg);
  }
  static isVercelCoreMessage(msg) {
    return !_MessageList.isMastraMessage(msg) && chunkMW267UVU_cjs.isCoreMessage(msg);
  }
...
//# sourceMappingURL=chunk-OFZZZ22B.cjs.map
//# sourceMappingURL=chunk-OFZZZ22B.cjs.map