...
var CoreToolBuilder = class extends chunkYT4RGZYO_cjs.MastraBase {
  originalTool;
  options;
  logType;
  constructor(input) {
  ...
  getParameters = () => {
    if (chunkH65GI7JY_cjs.isVercelTool(this.originalTool)) {
  ...
  createExecute(tool, options, logType) {
    ...
    const execFunction = async (args, execOptions) => {
      if (chunkH65GI7JY_cjs.isVercelTool(tool)) {
...
//# sourceMappingURL=chunk-MW267UVU.cjs.map
//# sourceMappingURL=chunk-MW267UVU.cjs.map