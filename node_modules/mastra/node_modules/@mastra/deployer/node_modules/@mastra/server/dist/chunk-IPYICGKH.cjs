  ...
  try {
    ...
    const serializedTools = Object.entries(tools).reduce(
      (acc, [id, _tool]) => {
        ...
        acc[id] = {
          ...tool,
          inputSchema: tool.inputSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(tool.inputSchema)) : void 0,
          outputSchema: tool.outputSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(tool.outputSchema)) : void 0
        };
        return acc;
      },
      {}
...
//# sourceMappingURL=chunk-IPYICGKH.cjs.map
//# sourceMappingURL=chunk-IPYICGKH.cjs.map