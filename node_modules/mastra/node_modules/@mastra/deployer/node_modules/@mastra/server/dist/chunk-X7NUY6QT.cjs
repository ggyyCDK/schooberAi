  ...
  try {
    ...
    const _workflows = Object.entries(workflows).reduce((acc, [key, workflow]) => {
      ...
      acc[key] = {
        ...
        name: workflow.name,
        triggerSchema: workflow.triggerSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(workflow.triggerSchema)) : void 0,
        steps: Object.entries(workflow.steps).reduce((acc2, [key2, step]) => {
          ...
          acc2[key2] = {
            ...
            inputSchema: _step.inputSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(_step.inputSchema)) : void 0,
            outputSchema: _step.outputSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(_step.outputSchema)) : void 0
          };
          return acc2;
        }, {})
      };
...
//# sourceMappingURL=chunk-X7NUY6QT.cjs.map
//# sourceMappingURL=chunk-X7NUY6QT.cjs.map