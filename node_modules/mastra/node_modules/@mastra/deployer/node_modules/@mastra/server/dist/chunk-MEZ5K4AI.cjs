...
function getSteps(steps, path) {
  return Object.entries(steps).reduce((acc, [key, step]) => {
    ...
    acc[fullKey] = {
      ...
      inputSchema: step.inputSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(step.inputSchema)) : void 0,
      outputSchema: step.outputSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(step.outputSchema)) : void 0,
      resumeSchema: step.resumeSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(step.resumeSchema)) : void 0,
      suspendSchema: step.suspendSchema ? chunkLCODOYFR_cjs.stringify(chunkLCODOYFR_cjs.esm_default(step.suspendSchema)) : void 0,
...
//# sourceMappingURL=chunk-MEZ5K4AI.cjs.map
//# sourceMappingURL=chunk-MEZ5K4AI.cjs.map